...
export default function WelcomePage() {
  ...
  const opacityCity =  useTransform(scrollY, [0, 300, 500, 800], [1, 0.5, 0.3, 0])
  const yHero = useTransform(scrollY, [0,200], [0,-150])
  const opacityHero =  useTransform(scrollY, [0, 200, 500, 800], [1, 1, 1, 0])
  const scaleText = useTransform(scrollY, [0,300], [1,1.5])
  const yText = useTransform(scrollY, [0, 300, 500, 800], [0, 50, 50, 300])
